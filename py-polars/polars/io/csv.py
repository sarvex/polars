...
def read_csv(
    ...
    if (
        ...
        return pli._update_columns(df, new_columns) if new_columns else df
    ...
    if new_columns and dtypes and isinstance(dtypes, dict):
        ...
        if columns:
            ...
            current_columns = columns[:len(new_columns)]
        elif not has_header:
        ...
        elif len(dtypes) <= len(new_columns):
            ...
            dtype_list = [
                ...
                for new_column_name in new_columns[: len(dtypes)]
